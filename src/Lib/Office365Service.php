<?php  namespace MspPack\OutLookCalendar\Lib;
...
use DateTimeZone;
  ...
  class Office365Service {
    ...
    public static function getLoginUrl($redirectUri) {
      $loginUrl = self::$authority.sprintf(self::$authorizeUrl, config('laravel-outlook-calendar.client_id'), urlencode($redirectUri));
    ...
    public static function getTokenFromAuthCode($authCode, $redirectUri) {
      ...
      $token_request_data = array(
        ...
        "client_id" => config('laravel-outlook-calendar.client_id'),
        "client_secret" => config('laravel-outlook-calendar.client_secret')
      );
      ...
      if (self::$enableFiddler) {
        ...
        curl_setopt($curl, CURLOPT_PROXY, "127.0.0.1:8000");
      }
    ...
    public static function addEventToCalendar($access_token, $subject, $location, $startTime, $endTime, $attendeeString) {
      ...
      $htmlBody = "<html><body>Added by dais.</body></html>";
